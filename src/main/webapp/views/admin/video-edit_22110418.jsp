...
<form action="<c:url value='/admin/video/update'></c:url>" method="post"
	...
	<input type="radio" id="ston" name="status" value="1"${video.active == true ? 'checked' : ''}> <label for="ston">Hoạt động</label> 
	<input type="radio" id="stoff" name="status" value="0" ${video.active == false ? 'checked' : ''}> <label for="stoff">Khóa</label><br> 
